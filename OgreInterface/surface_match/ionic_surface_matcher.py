...
class IonicSurfaceMatcher:
    ...
    def get_optmized_structure(self):
        ...
        self.interface.shift_film_inplane(
            x_shift=self.opt_x_shift, y_shift=self.opt_y_shift, fractional=True
        )
    ...
    def run_surface_matching(
        ...
        # TODO: Make surface matching work with updated shifting and remove second input generation of the z-shift by just adding the z-shift to the z-component of the film_atoms
        shifts = self.shifts
